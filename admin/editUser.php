<?php
include "./config.php"; // Fichier de configuration global

$id = $_GET['id']; // On recuperer l'id de l'utilisateur
$qry = mysqli_query($conn, "SELECT * from users where id_user='$id'"); // On selectionne tout les utilisateurs
...
<form method="POST">
    <input type="text" name="login_user" value="<?php echo $data['login_user'] ?>" placeholder="Pseudo" Required>
    <input type="text" name="first_name_user" value="<?php echo $data['first_name_user'] ?>" placeholder="Prénom" Required>
