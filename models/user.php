<?php
    ...
    {   
        ...
        //type_user Getter and Setter
        public function getTypeuser()
        {
            return $this->type_user;
        }
        public function setTypeuser($newTypeuser)
        {
            $this->type_user = $newTypeuser;
        }
        ...
        {   
            ...
            {   
                ...
                $req = $bdd->prepare('INSERT INTO users(name_user, first_name_user, login_user, mdp_user, type_user) 
                VALUES (:name_user, :first_name_user, :login_user, :mdp_user, :type_user)');
